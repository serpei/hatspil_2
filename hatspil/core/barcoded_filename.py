...
class Tissue(IntEnum):
    ...
    def is_normal(self) -> bool:
        ...
        return self in (
            ...
            Tissue.BLOOD_DERIVED_MOTHER,
            Tissue.BLOOD_DERIVED_FATHER,
            Tissue.IMMUNE_CELL_DERIVED_TUMOR,
        )
    ...
    def is_tumor(self) -> bool:
        ...
        return self in (
            ...
            Tissue.BIOPSY_PRIMARY_SOLID_TUMOR,
            ...
            Tissue.TUMOR_ORGANIC_CELLS,
            Tissue.BIOPSY_RECURRENT_TUMOR,
            Tissue.BIOPSY_METASTASIS,
            Tissue.METASTASIS,
            Tissue.ADDITIONAL_METASTASIS,
            Tissue.METASTASIS_OF_RECURRENT_TUMOR,
            Tissue.BIOPSY_METASTASIS_OF_RECURRENT_TUMOR,
            Tissue.SECOND_METASTASIS_OF_RECURRENT_TUMOR,
            Tissue.BIOPSY_SECOND_METASTASIS_OF_RECURRENT_TUMOR,
            Tissue.CELL_LINE_DERIVED_PRIMARY_TUMOR,
            Tissue.CELL_LINE_DERIVED_METASTASIS,
            Tissue.CELL_LINE_DERIVED_NORMAL_TISSUE,
            Tissue.CELL_LINE_DERIVED_MOUSE_NORMAL_TISSUE,
            Tissue.CELL_LINE_DERIVED_MOUSE_PRIMARY_TUMOR,
            Tissue.CELL_LINE_DERIVED_RECURRENT_TUMOR,
            Tissue.CELL_LINE_DERIVED_METASTASIS_OF_RECURRENT_TUMOR,
            Tissue.PRIMARY_XENOGRAFT_TISSUE,
            Tissue.CELL_LINE_DERIVED_XENOGRAFT_TISSUE,
            Tissue.CELL_LINE_XENOGRAFT_TISSUE,
            Tissue.ORGANOIDS_DERIVED_PRIMARY_TUMOR,
            Tissue.ORGANOIDS_DERIVED_METASTASIS,
            Tissue.ORGANOIDS_DERIVED_NORMAL_TISSUE,
            Tissue.ORGANOIDS_DERIVED_CELL_LINE,
            Tissue.ORGANOIDS_DERIVED_RECURRENT_TUMOR,
            Tissue.ORGANOIDS_DERIVED_METASTASIS_OF_RECURRENT_TUMOR,
            Tissue.SPHEROIDS_DERIVED_PRIMARY_TUMOR,
            Tissue.SPHEROIDS_DERIVED_METASTASIS,
            Tissue.SPHEROIDS_DERIVED_NORMAL_TISSUE,
            Tissue.SPHEROIDS_DERIVED_CELL_LINE,
            Tissue.SPHEROIDS_DERIVED_RECURRENT_TUMOR,
            Tissue.SPHEROIDS_DERIVED_METASTASIS_OF_RECURRENT_TUMOR,
        )
